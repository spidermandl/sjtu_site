<div class="homebox">
    <div class="conbox">
        <?php echo($menu); ?>
          <div class="right fr">
            <div class="panels_pane panel-pane pane-node-body right_nr">
            <!-- <div class="panels_pane panel-pane pane-views-panes pane-news-panel-pane-1 right_nr"> -->
                ...
                <div class="pane-content">
                    <?php if ($child->type == JT::$STRUCTURE['DIRECTORY']):?>
                                      ...
                                      <?php if ($i == $start):?>
                                          ...
                                          <?php else:?>
                                              <li class="pager-first first">
                                                  <a href="<?php e::url(JT::category_string($child->parent_id).'/'.$template_id);?>" title="Go to first page" class="active">« first</a>
                                              </li>
                                              <li class="pager-previous">
                                                  <a href="<?php e::url(JT::category_string($child->parent_id).'/'.$template_id.'/page/'.($current_page-1));?>" title="Go to previous page" class="active">‹ previous</a>
                                              </li>
                                              <?php if ($start != 1):?>
